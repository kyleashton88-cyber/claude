...
**Current structure (source of truth):** `programs/defi-program/01-offer-and-curriculum.md`: 6 stages, 15 modules, 76 lessons, from Crypto From Zero to Operate as Your Own Bank. The grouping below is the original ATLAS mapping for Modules 1–9.
