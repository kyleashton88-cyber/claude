...
| `video/` | 18 core videos (≈3.5-min main VSL, 30s vertical VSL, welcome, 15 module intros) + sample lessons 0.1, 2.7 and 3.2; `thumbs/`, `captions/` (WebVTT), `chapters/`, `SCRIPTS.md` | Rendered by `export/build_video.js` |
