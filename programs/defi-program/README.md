...
| `video/` | 19 core videos (≈3.5-min main VSL, 30s vertical VSL, 1-min welcome and 10-min welcome tour, 15 module intros) + all 121 lesson and Mastery Starter videos (about 6 hours, each under 7 minutes; 8.3 series still to script); `thumbs/`, `captions/` (WebVTT), `chapters/`, `SCRIPTS.md` | Rendered by `export/build_video.js` |
