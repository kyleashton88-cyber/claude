...
| `video/` | 20 core videos (≈3.5-min main VSL, 30s vertical VSL, 1-min welcome, 10-min welcome tour, 23-min "How the program works" walkthrough, 10-min Day-1 Setup Kit guide, 15 module intros, Module 0's a story-led long form for complete beginners) + all 121 lesson and Mastery Starter videos (about 6 hours, each under 7 minutes; 8.3 series still to script); `thumbs/`, `captions/` (WebVTT), `chapters/`, `SCRIPTS.md` | Rendered by `export/build_video.js` |
